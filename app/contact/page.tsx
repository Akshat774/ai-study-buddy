					...
					{[
						...
						return (
							<motion.div
								...
								data-animate
							>
								<div className={`inline-block p-3 rounded-lg bg-gradient-to-br ${item.color} text-white mb-4`}>
					...
					>
						...
						<div className="space-y-4 text-sm">
							...
							<div>
								...
								<p className="text-muted-foreground dark:text-gray-300">
									Yes! Our support team is available to help with any technical issues.
								</p>
							</div>
							<div>
								<p className="font-semibold dark:text-purple-300 mb-1">
								...
								<p className="text-muted-foreground dark:text-gray-300">
									Absolutely! Contact us to schedule a personalized demo with our team.
								</p>
							</div>
						</div>
						...
						<div className="mt-8 p-4 bg-white dark:bg-slate-700 rounded-lg border-l-4 border-purple-600">
							<p className="text-sm dark:text-gray-300">
								<strong>Pro Tip:</strong> For urgent matters, you can also reach out via email with "URGENT" in the subject line.
							</p>
						</div>
					</motion.div>
				</div>
