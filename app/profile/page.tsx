					...
					<div>
						...
						<div className="mb-12 text-center">
							<div className="flex justify-center mb-6">
								<div className="p-4 rounded-2xl bg-gradient-to-br from-purple-600 to-blue-600 shadow-xl">
									<User className="w-10 h-10 text-white" />
								</div>
							</div>
							<h1 className="text-5xl font-bold tracking-tight bg-gradient-to-r from-purple-700 to-blue-600 bg-clip-text text-transparent mb-4">
								Create Your Profile
							</h1>
							<p className="text-lg text-gray-600 max-w-2xl mx-auto">
								Help us personalize your study experience by sharing a few details about yourself
							</p>
						</div>
										...
										<CardContent>
											<div className="flex flex-col items-center gap-4">
												<div
													...
													className="w-24 h-24 rounded-full bg-gradient-to-br from-purple-100 to-blue-100 dark:from-purple-900/30 dark:to-blue-900/30 flex items-center justify-center cursor-pointer hover:shadow-lg transition-shadow border-2 border-dashed border-purple-300 dark:border-purple-500/50"
												>
													{photoPreview ? (
										...
										<CardContent>
											<form onSubmit={handleCompleteProfile} className="space-y-6">
												...
												<Button
													type="submit"
													disabled={loading}
													className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white hover:scale-[1.02] transition h-10 text-base"
												>
													{loading ? (
